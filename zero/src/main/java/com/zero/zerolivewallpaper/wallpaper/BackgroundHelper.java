...
public class BackgroundHelper {
    ...
    public static List<Layer> loadFromFile(String id, Context context) {
        // Create final list
    ...
    /*
    static String getURLForResource()
    {
        return Uri.parse();
    }
    */
    ...
    public static Bitmap decodeScaledFromRes(Resources res, int id) {
        // Get the size
        final BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
